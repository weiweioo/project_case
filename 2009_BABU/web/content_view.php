  ...
  <main class="main-all index">
    <section class=" wow fadeIn">
      <div class="content-all">
        ...
        <!-- //左側選單區塊 -->
        <section class="right-box art-view">
          <!-- ==============文章內文============== -->
          <div class="main-art">
            <div class="art-top">
              <div class="art-user">
            ...
            <ul class="art-icon">
              <li>
                <a  href="javascript:;" title="按讚" class="current">
              ...
              <li>
                <a data-fancybox data-src="#ind-thumbs" href="javascript:;" title="評價" class="current">
                  <div class="at-ic good"><i class="far fa-star"></i></i></div>
                  <div class="h "><i class="far fa-star"></i></div>
                  評價<span class="qty">4.5</span>
                </a>
