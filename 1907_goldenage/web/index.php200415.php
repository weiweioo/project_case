<?php include '_header.php';?>
    ...
    <main class="">
        <article>
            ...
            <section class="index_building indexContent fadeInUp animated wow" data-wow-duration="1s"
            data-wow-delay="0.3s">
            ...
            <section class="index_news fadeIn animated wow" data-wow-duration="1.5s"
            data-wow-delay="0.3s">
            ...
            <section class="index_events fadeInLeft animated wow " data-wow-duration="1.8s"
            data-wow-delay="0.3s">
            ...
            <section class="index_environment indexContent fadeInRight animated wow"
            ...
            <section class="index_space  fadeInLeft animated wow" data-wow-duration="2s"
            data-wow-delay="0.3s">
            ...
            <section class="index_prod indexContent fadeInUp animated wow" data-wow-duration="0.8s"
            data-wow-delay="0.3s">
