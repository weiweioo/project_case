                ...
                <div class="pop-up">
                    <div class="content">
                        <div class="container">
                            ...
                            <input class="email" type="text" id="email" class="link-input" placeholder="請輸入您的信箱">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="other-sign">
                            ...
                            <p>
                                您不需先加入會員，可以直接進行購物， 我們將在結帳過程幫助您成為會員，以便您查詢訂單，謝謝您。
                            </p>
                            <div class="form-btn">
                                <a href="cart.php" class="sign-btn" title="結帳">
                                    結帳
                                </a>
                            </div>
                        </div>
