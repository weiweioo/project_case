...
<main id="wrap">
  ...
  <div class="classBox wow fadeIn">
    ...
    <ul class="classLink">
      ...
      <li><a href="study_abroad_view_02.php" class="current unit_link">英國學士</a></li>
      ...
      <div class="faq-box-all se1">
        ...
        <div class="qaBox">
          ...
          <ul class="qa-info">
            ...
            <li>
              <a href="SRC/images/uti-idp01.jpg" data-lightbox="image-0">
                <img src="SRC/images/uti-idp01.jpg" alt="">
              </a>
            </li>
          </ul>
        </div>
      ...
      <section>
        ...
        <div class="step-all-box uti-view-step">
          <div class="step-box wow fadeInUp">
            ...
            <div class="des">
              進入IDP加發頁面：
              <a href="https://www.ieltstaiwan.org/apply-extra-test-report-forms-tc/" target="_blank">https://www.ieltstaiwan.org/apply-extra-test-report-forms-tc/</a>
              請將該頁面下移，填寫個人資料並<strong>選擇加發學校/加發方式。</strong></br>
              <strong>提供電子加發的學校名單</strong>，可參考其PDF檔。</br>若沒有提供電子加發，則請選擇紙本加發。</br>
            </div>
            <div class="step-pic">
              <a href="SRC/images/uti-idp02.jpg" data-lightbox="image-1">
                <img src="SRC/images/uti-idp02.jpg" alt="">
              </a>
            </div>
          </div>
          <div class="step-box wow fadeInUp">
          ...
          <div class="step-box wow fadeInUp">
            ...
            <div class="des">
            IDP收到加發申請，將發系統通知信。尚須進行以下指示完成加發流程：<br>
           <span>*請將您的成績單影本、護照影本 e-mail 到 TW001.administrator@idp.com</span><br>
           <span>*郵件標題請寫 [成績單加發_您的姓名]</span>
            </div>
            <div class="step-pic">
              <a href="SRC/images/uti-idp03.jpg" data-lightbox="image-3">
                <img src="SRC/images/uti-idp03.jpg" alt="">
              </a>
            </div>
          </div>
        </div>
