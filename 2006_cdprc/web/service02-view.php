...
<main class="in-page">
  <div class="content">
    <div class="page-top wow fadeIn">
      <div class="inp-tt01">
        <a href="service02-list-year.php">
      ...
      <section class="classBox ">
        <ul class="classLink">
          ...
          <li><a class="current" href="service02-list-year.php">學術活動</a></li>
        </ul>
      </section>
      <!--classLink end-->
    </div>
    <div class="service-view">
      ...
      <section class="page-top-view wow fadeIn">
        ...
        <div class="right-box">
          <ul>
            <li>
              <div class="li-tt01">學術名稱:</div>109年第一期水土保育宣導
            </li>
            <li>
              <div class="li-tt01">課程日期:</div>109/10/24-25
            </li>
            <li>
              <div class="li-tt01">課程年度:</div>109年
            </li>
            <li>
              <div class="li-tt01">演講人經歷及學歷：</div>何智超-國立交通大學土木工程學系博士
            </li>
            <li>
      ...
      <section class="page-bot-view wow fadeIn">
        ...
        <div class="user_editor">
          ...
          <div class="bot-box-pic">
            <img src="SRC/images/ser-view-02.jpg">
          </div>
        </div>
        <!--//service-con-->
        <div class="back-to">
