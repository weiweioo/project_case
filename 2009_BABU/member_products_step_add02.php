                ...
                <ul class="styled-input">
                  ...
                  <li class="maa-top-check">
                    <label><span><i class="fas fa-exclamation"></i></span>是否為體驗活動文章</label>
                     ...
                     <input class="experience-input" readonly="readonly" type="text" value="是" />
              ...
              <div class="art-box2">
                <ul class="styled-input">
                  <li class="">
                    ...
                    <input class="experience-input" readonly="readonly" type="text" value="健身器材" />
                  </li>
                  <li>
                    <label>品牌</label>
                    <input readonly="readonly" type="text" value="雅詩蘭黛" />
                  </li>
                  <li>
                    <label>商品名稱</label>
                    <input readonly="readonly" type="text" value="情挑誘光唇膏" />
                  </li>
