            ...
            <div class="member03">
              <form action="javascript:void(0)">
                <ul class="styled-input">
                  <li>
                    <label>會員等級</label>
                    <input type="text" readonly="readonly" value="普通會員" class="onlyread">
                  </li>
                  <li class="txt">
                    <a class="mb-text" data-fancybox data-src="#mber-icon" href="javascript:;"><span>升級為VIP會員</span><i class="gen-mber fas fa-crown"></i></a>
                    <div style="display: none;" id="mber-icon">
                      <form class="mber-icon-con">
                        <div class="tit">
                          親愛的會員您好，升級為VIP會員，請上傳含出生年月的證件圖檔
                        </div>
                        <div class="file-box">
                        ...
                        <div class="file-txt">※限jpg、png、gif，尺寸200 x 200像素</div>
                        <ul class="styled-input">
                          <li>
                            <label>身分證字號*</label>
                        ...
                        <input type="submit" class="file-btn btn-style01" onclick="location='member_account_vip.php'" value="確認送出">
                      </form>
                    </div>
                  </li>
                  <li>
